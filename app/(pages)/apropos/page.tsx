...
export default function page() {
  return (
    ...
    <GardePage title={"A propos"} />
     ...
     <p className='w-5/6 mx-auto py-8 text-center text-lg md:text-xl lg:text-2xl font-medium leading-relaxed tracking-wide'>Chez Zenith Digit, nous accompagnons les entreprises dans leur transformation numérique pour les aider à atteindre leur plein potentiel. Passionnée par la technologie et le marketing, notre équipe collabore étroitement avec chaque client pour concevoir des stratégies digitales personnalisées et maximiser leur visibilité.</p>
     </div>
     <VisionSection />
     <div className="border-b-4 border-[#00fefb]">
