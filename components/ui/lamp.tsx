...
export default function Lamp({titre}:{titre:string}) {
  return (
    <LampContainer>
      <motion.h1
        ...
        className="mt-8 bg-gradient-to-br from-[#00fefb] to-[#00fefb] py-4 bg-clip-text text-center text-4xl font-medium tracking-tight text-transparent md:text-7xl"
      >
        {titre}
      </motion.h1>
    </LampContainer>
...
export const LampContainer = ({
  ...
  return (
    <div
      className={cn(
        "relative flex h-52 flex-col items-center justify-center overflow-hidden bg-slate-950 w-full rounded-md z-0",
        className
      )}
    >
